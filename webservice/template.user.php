...
<head>
    ...
    <title>HALAMAN MYSAP CUSTOMER</title>
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="?halaman=pemesanan">Pemesanan</a></li>
                        </ul>
                    </li>
					<li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>History Pembelian</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="?halaman=pembelian">Data Pembelian</a></li>
                        </ul>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="col-12 col-md-6 d-flex justify-content-end align-items-center">
                    ...
                    <div class="user-area dropdown ml-4">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="image/user.png" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="?halaman=profil"><i class="fa fa-user"></i> Profil</a>
	   ...
	   if(file_exists("./page.user.".getPage().".php")) {
		   include_once "./page.user.".getPage().".php";
	   } else {
		   ?>
